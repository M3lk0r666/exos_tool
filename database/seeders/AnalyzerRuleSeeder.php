...
class AnalyzerRuleSeeder extends Seeder
{
    public function run(): void
    {
        $rules = [
            ...
            ['code' => 'LOG-CPU', 'analyzer' => 'CpuAnalyzer', 'description' => 'Alertas EPM.cpu del propio equipo: proceso consumiendo % de CPU (umbral sobre el % máximo reportado)', 'threshold_warning' => 40, 'threshold_critical' => 70, 'level_warning' => 'medium', 'level_critical' => 'high'],
            ['code' => 'LOG-WARN', 'analyzer' => 'LogsAnalyzer', 'description' => 'Eventos Warn de componentes operativos vigilados (lista editable en params.components)', 'threshold_warning' => 1, 'threshold_critical' => null, 'level_warning' => 'medium', 'level_critical' => null, 'params' => ['components' => ['HAL.Card.Warning', 'HAL.Sys.Warning', 'Kern.Card.Warning', 'DM.Warning', 'ELRP', 'FDB.MACMove', 'HAL.Stacking', 'EPM.Stacking', 'HAL.Power', 'HAL.PSU', 'DOSProt']]],
            ['code' => 'LOG-FLAP', 'analyzer' => 'PortsAnalyzer', 'description' => 'Eventos de caída de link por puerto registrados en el log (flapping observado, aunque el estado actual sea OK)', 'threshold_warning' => 50, 'threshold_critical' => 200, 'level_warning' => 'medium', 'level_critical' => 'high'],
        ...
        $references = [
            ...
            'LOG-CPU' => 'Monitor de CPU del propio EXOS (<Warn:EPM.cpu>); KB GTAC 000107097 (proceso hal en alto consumo)',
            'LOG-WARN' => 'Warnings operativos del catálogo EXOS; KB GTAC 000112095 (HAL.Card.Warning slot not present). Incluye loops (ELRP/MACMove), stacking y alimentación',
            'LOG-FLAP' => 'Eventos vlan.msgs.portLinkStateDown del catálogo EXOS: incidentes pasados visibles en log aunque el estado actual sea normal',
